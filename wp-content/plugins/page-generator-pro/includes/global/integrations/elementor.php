...
class Page_Generator_Pro_Elementor extends Page_Generator_Pro_Integration {
	...
	public function register_elementor_scripts_css() {
		...
		if ( sanitize_text_field( $_GET['action'] ) !== 'elementor' ) { // phpcs:ignore WordPress.Security.NonceVerification
			return;
		}
	...
	public function set_current_screen( $result ) {
		...
		if ( sanitize_text_field( $_REQUEST['action'] ) !== 'elementor_ajax' ) { // phpcs:ignore WordPress.Security.NonceVerification
			return $result;
		}
