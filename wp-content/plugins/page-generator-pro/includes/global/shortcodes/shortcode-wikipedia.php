...
class Page_Generator_Pro_Shortcode_Wikipedia extends Page_Generator_Pro_Shortcode_Base {
	...
	public function get_overview() {
		...
		return array(
			...
			'gutenberg_icon'              => $this->base->get_class( 'common' )->file_get_contents( $this->base->plugin->folder . '/_modules/dashboard/feather/wikipedia.svg' ),
		);
	...
	public function render( $atts ) {
		...
		if ( ! isset( $elements ) ) {
			if ( defined( 'PAGE_GENERATOR_PRO_DEBUG' ) && PAGE_GENERATOR_PRO_DEBUG === true ) {
				return __( 'Wikipedia: No Terms were specified, or Terms are Keywords which evaluate to blank Terms.', 'page-generator-pro' );
			}
