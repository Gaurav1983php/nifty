...
class Page_Generator_Pro_Log {
	...
	public function run_log_table_bulk_actions() {
		...
		$bulk_action = array_values(
			array_filter(
				array(
					( isset( $_REQUEST['bulk_action'] ) && $_REQUEST['bulk_action'] != '-1' ? sanitize_text_field( $_REQUEST['bulk_action'] ) : '' ), // phpcs:ignore WordPress.PHP.StrictComparisons.LooseComparison
					( isset( $_REQUEST['bulk_action2'] ) && $_REQUEST['bulk_action2'] != '-1' ? sanitize_text_field( $_REQUEST['bulk_action2'] ) : '' ), // phpcs:ignore WordPress.PHP.StrictComparisons.LooseComparison
	...
	private function redirect() {
		...
		foreach ( $this->get_filters() as $filter ) {
			if ( ! isset( $_REQUEST[ $filter ] ) ) { // phpcs:ignore WordPress.Security.NonceVerification
				continue;
			}
	...
	public function get_search_params() {
		...
		$search = esc_html( $_REQUEST['s'] ); // phpcs:ignore WordPress.Security.NonceVerification
	...
	public function get_system() {
		...
		return ( isset( $_REQUEST['system'] ) ? esc_html( $_REQUEST['system'] ) : '' ); // phpcs:ignore WordPress.Security.NonceVerification
	...
	public function get_result() {
		...
		return ( isset( $_REQUEST['result'] ) ? esc_html( $_REQUEST['result'] ) : '' ); // phpcs:ignore WordPress.Security.NonceVerification
	...
	public function get_generated_at_start_date() {
		...
		return ( isset( $_REQUEST['generated_at_start_date'] ) ? esc_html( $_REQUEST['generated_at_start_date'] ) : '' ); // phpcs:ignore WordPress.Security.NonceVerification
	...
	public function get_generated_at_end_date() {
		...
		return ( isset( $_REQUEST['generated_at_end_date'] ) ? esc_html( $_REQUEST['generated_at_end_date'] ) : '' ); // phpcs:ignore WordPress.Security.NonceVerification
	...
	public function get_order_by() {
		...
		return ( isset( $_GET['orderby'] ) ? sanitize_sql_orderby( $_GET['orderby'] ) : 'generated_at' ); // phpcs:ignore WordPress.Security.NonceVerification
