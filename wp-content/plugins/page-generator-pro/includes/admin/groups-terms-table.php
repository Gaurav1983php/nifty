...
class Page_Generator_Pro_Groups_Terms_Table {
	...
	public function run_row_actions() {
		...
		$action = sanitize_text_field( $_REQUEST[ $this->base->plugin->name . '-action' ] ); // phpcs:ignore WordPress.Security.NonceVerification
	...
	private function get_search() {
		...
		return ( isset( $_GET['s'] ) ? sanitize_text_field( urldecode( $_GET['s'] ) ) : '' ); // phpcs:ignore WordPress.Security.NonceVerification
	...
	private function get_order_by() {
		...
		return ( isset( $_GET['orderby'] ) ? sanitize_text_field( $_GET['orderby'] ) : '' ); // phpcs:ignore WordPress.Security.NonceVerification
