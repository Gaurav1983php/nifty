...
class Page_Generator_Pro_Creative_Commons extends Page_Generator_Pro_API {
	 ...
	 * @return  mixed                   WP_Error | array
	 */
	private function search( $query = false, $orientation = false, $licenses = false, $sources = false, $per_page = 500, $page = 1 ) { // phpcs:ignore Generic.CodeAnalysis.UnusedFunctionParameter
