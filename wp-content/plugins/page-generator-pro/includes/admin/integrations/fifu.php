...
class Page_Generator_Pro_FIFU extends Page_Generator_Pro_Integration {
	 ...
	 */
	public function output_meta_box_featured_image( $post, $settings ) { // phpcs:ignore Generic.CodeAnalysis.UnusedFunctionParameter
	 ...
	 */
	public function copy_featured_image_data( $image_id, $post_id, $group_id, $index, $settings, $post_args ) { // phpcs:ignore Generic.CodeAnalysis.UnusedFunctionParameter
