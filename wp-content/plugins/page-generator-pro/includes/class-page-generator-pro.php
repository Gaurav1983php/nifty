...
class Page_Generator_Pro {
	...
	private function initialize_admin_or_frontend_editor() {
		...
		if ( $this->licensing->check_license_key_valid() ) {
			...
			$this->classes->research_ai_writer         = new Page_Generator_Pro_Research_AI_Writer( self::$instance );
			$this->classes->research_articleforge      = new Page_Generator_Pro_Research_ArticleForge( self::$instance );
			$this->classes->research_contentbot        = new Page_Generator_Pro_Research_ContentBot( self::$instance );
			$this->classes->research_openai            = new Page_Generator_Pro_Research_OpenAI( self::$instance );
			...
			$this->classes->spintax_chimprewriter      = new Page_Generator_Pro_Spintax_ChimpRewriter( self::$instance );
			$this->classes->spintax_spin_rewriter      = new Page_Generator_Pro_Spintax_Spin_Rewriter( self::$instance );
			$this->classes->spintax_spinnerchief       = new Page_Generator_Pro_Spintax_SpinnerChief( self::$instance );
			$this->classes->spintax_wordai             = new Page_Generator_Pro_Spintax_WordAI( self::$instance );
