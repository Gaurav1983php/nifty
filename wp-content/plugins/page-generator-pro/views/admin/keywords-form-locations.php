						...
						<div id="normal-sortables" class="meta-box-sortables ui-sortable">                        
							<div id="keyword-panel" class="postbox">
								...
								<div class="wpzinc-option">
									...
									<div class="right">
										<input type="number" name="population_min" min="0" max="99999999" value="" placeholder="<?php esc_attr_e( 'Min.', 'page-generator-pro' ); ?>" />
										-
								...
								<div class="wpzinc-option">
									...
									<div class="right">
										<input type="number" name="median_household_income_min" min="0" max="99999999" value="" placeholder="<?php esc_attr_e( 'Min.', 'page-generator-pro' ); ?>" />
										-
										<input type="number" name="median_household_income_max" min="0" max="99999999" value="" placeholder="<?php esc_attr_e( 'Max.', 'page-generator-pro' ); ?>" />
