<?php
/**
 * Outputs the form at Keywords > Import CSV or Spreadsheet
 *
...
<div class="wrap">
	<h1 class="wp-heading-inline">
		<?php esc_html( $this->base->plugin->displayName ); ?>

		<span>
			<?php esc_html_e( 'Import CSV or Spreadsheet', 'page-generator-pro' ); ?>
		</span>
	</h1>
					...
					<form name="post" method="post" action="admin.php?page=page-generator-pro-keywords&amp;cmd=form-import-file" enctype="multipart/form-data">		
						<div id="normal-sortables" class="meta-box-sortables ui-sortable">                        
							<div id="keyword-panel" class="postbox">
								<h3 class="hndle"><?php esc_html_e( 'Import CSV or Spreadsheet', 'page-generator-pro' ); ?></h3>

								<div class="wpzinc-option">
									<div class="left">
										<strong><?php esc_html_e( 'File', 'page-generator-pro' ); ?></strong>
									</div>
									<div class="right">
										<input type="file" name="file" />

										<p class="description">
											<?php esc_html_e( '.csv and .xlsx files are supported', 'page-generator-pro' ); ?>
										</p>
									</div>
								</div>
								...
								<div class="wpzinc-option">
									<div class="left">
										<strong><?php esc_html_e( 'Import Method', 'page-generator-pro' ); ?></strong>
									</div>
									<div class="right">
										<div class="wpzinc-horizontal-selection options-4">
											<label for="columns_single_keyword">
												...
												<span><?php esc_html_e( 'Import Columns into a single Keyword', 'page-generator-pro' ); ?></span>
											...
											<label for="columns_multiple_keywords">
												...
												<span><?php esc_html_e( 'Import Columns as multiple Keywords', 'page-generator-pro' ); ?></span>
											...
											<label for="rows_single_keyword">
												...
												<span><?php esc_html_e( 'Import Rows into a single Keyword', 'page-generator-pro' ); ?></span>
											...
											<label for="rows_multiple_keywords">
												...
												<span><?php esc_html_e( 'Import Rows as multiple Keywords', 'page-generator-pro' ); ?></span>
										...
										<p class="description">
											<?php esc_html_e( 'Choose an option above, based your CSV / spreadsheet file\'s structure and how you want to store the imported data.', 'page-generator-pro' ); ?>
										</p>
									</div>
								</div>
								...
								<div class="wpzinc-option">
									<div class="left">
										<strong><?php esc_html_e( 'Delimiter', 'page-generator-pro' ); ?></strong>
									</div>
									<div class="right">
										<input type="text" name="delimiter" value="," class="widefat" />
										<p class="description">
											<?php esc_html_e( 'For CSV Files, the delimiter used in the CSV file to separate cells.', 'page-generator-pro' ); ?>
										</p>
									</div>
								</div>
								...
								<div>
									<div class="columns_single_keyword rows_single_keyword">
										<div class="wpzinc-option">
											<div class="left">
												<strong><?php esc_html_e( 'Keyword Name', 'page-generator-pro' ); ?></strong>
											</div>
											<div class="right">
								...
								<div class="wpzinc-option">
									...
									<input type="submit" name="submit" value="<?php esc_attr_e( 'Import', 'page-generator-pro' ); ?>" class="button button-primary" />
								</div>
							</div>
						</div>
						<!-- /normal-sortables -->
