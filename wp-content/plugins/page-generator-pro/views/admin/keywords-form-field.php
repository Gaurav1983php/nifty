...
<div class="wpzinc-option">
	...
	<div class="right"<?php echo esc_attr( $option['type'] === 'preview' ? ' style="overflow-x:hidden;"' : '' ); ?>>
		<?php
		// Output Form Field.
		switch ( $option['type'] ) {
			case 'text':
			...
			case 'number':
				?>
				<input type="number" name="<?php echo esc_attr( $source_name ); ?>[<?php echo esc_attr( $option_name ); ?>]" id="<?php echo esc_attr( $option_name ); ?>" value="<?php echo esc_attr( $value ); ?>" class="widefat" />
				<?php
				break;
