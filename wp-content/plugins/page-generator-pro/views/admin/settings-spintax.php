	...
	<div class="wpzinc-option">
		<p class="description">
			...
			echo sprintf(
				...
				esc_html__( 'and', 'page-generator-pro' ),
				'<a href="' . esc_attr( $this->base->plugin->documentation_url ) . '/generate-content/#fields--generation"  target="_blank" rel="noopener">' . esc_html__( 'Spin Content', 'page-generator-pro' ) . '</a>',
