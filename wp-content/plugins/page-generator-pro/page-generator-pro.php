...
define( 'PAGE_GENERATOR_PRO_PLUGIN_VERSION', '3.9.9' );
define( 'PAGE_GENERATOR_PRO_PLUGIN_BUILD_DATE', '2023-01-11 13:00:00' );
...
function page_generator_pro_autoloader( $class_name ) {
	...
	$include_paths = array(
		...
		dirname( __FILE__ ) . '/includes/admin/research/' . $file_name,
		dirname( __FILE__ ) . '/includes/admin/spintax/' . $file_name,
